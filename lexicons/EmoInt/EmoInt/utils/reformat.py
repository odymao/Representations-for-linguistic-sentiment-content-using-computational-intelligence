...
# inp_path='emoint/resources/NRC-emotion-lexicon-wordlevel-v0.92.txt.gz'
def reformat(inp_path='emoint/resources/NRC-emotion-lexicon-wordlevel-v0.92.txt.gz',
    ...
    # data = open(inp_path,'rt', encoding="utf8").read().splitlines()
...
if __name__ == '__main__':
    reformat('../resources/NRC-emotion-lexicon-wordlevel-v0.92.txt.gz')
    # if len(sys.argv) == 2:
    #     reformat(sys.argv[1])
    # elif len(sys.argv) == 3:
